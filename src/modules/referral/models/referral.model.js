...
const influencerProfileSchema = new mongoose.Schema(
  {
    ...
    onboardingStatus: { type: String, default: "pending_kyc", index: true },
    kycStatus: { type: String, default: "not_submitted", index: true },
    payoutProfileStatus: { type: String, default: "not_submitted", index: true },
