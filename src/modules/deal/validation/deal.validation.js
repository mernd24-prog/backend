...
const publicDealProductsSchema = {
  query: Joi.object({
    ...
    category_id: Joi.string().trim().allow("").max(180).optional(),
    brand: Joi.string().trim().allow("").max(180).optional(),
    brand_id: Joi.string().trim().allow("").max(180).optional(),
    sellerId: id.optional(),
    productId: id.optional(),
    dealType: Joi.string().valid(...Object.values(DEAL_TYPE)).optional(),
    ...
    rating: Joi.string().trim().allow("").max(40).optional(),
    minRating: Joi.string().trim().allow("").max(40).optional(),
    min_rating: Joi.string().trim().allow("").max(40).optional(),
    inStock: Joi.string().valid("true", "false").optional(),
    in_stock: Joi.string().valid("true", "false").optional(),
    outOfStock: Joi.string().valid("true", "false").optional(),
    out_of_stock: Joi.string().valid("true", "false").optional(),
    expressDelivery: Joi.string().valid("true", "false").optional(),
    express_delivery: Joi.string().valid("true", "false").optional(),
    freeDelivery: Joi.string().valid("true", "false").optional(),
    free_delivery: Joi.string().valid("true", "false").optional(),
