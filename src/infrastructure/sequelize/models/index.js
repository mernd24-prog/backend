...
const TaxInvoice = sequelize.define(
  "TaxInvoice",
  {
    ...
    invoiceType: { type: DataTypes.STRING(48), allowNull: false, defaultValue: "order_customer", field: "invoice_type" },
    sellerId: { type: DataTypes.STRING(64), field: "seller_id" },
    issuerType: { type: DataTypes.STRING(32), field: "issuer_type" },
    recipientType: { type: DataTypes.STRING(32), field: "recipient_type" },
    referenceType: { type: DataTypes.STRING(64), field: "reference_type" },
    referenceId: { type: DataTypes.STRING(128), field: "reference_id" },
    parentInvoiceId: { type: DataTypes.UUID, field: "parent_invoice_id" },
    issuedAt: { type: DataTypes.DATE, allowNull: false, field: "issued_at" },
    metadata: { type: DataTypes.JSONB, defaultValue: {} },
    createdBy: { type: DataTypes.STRING(64), field: "created_by" },
    updatedBy: { type: DataTypes.STRING(64), field: "updated_by" },
  },
  {
