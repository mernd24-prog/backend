...
const MODULE_ALIASES = {
  ...
  "payout-ops-queue": "sellers/commissions",
  payout_ops_queue: "sellers/commissions",
  "negative-balances": "sellers/commissions",
  negative_balances: "sellers/commissions",
  ...
  "commerce-settings-menu": "admin",
  commerce_settings_menu: "admin",
  "platform-commerce-settings": "admin",
  platform_commerce_settings: "admin",
  "seller-commerce-config": "admin",
  seller_commerce_config: "admin",
  "commerce-templates": "admin",
  commerce_templates: "admin",
  "seller-tiers": "admin",
  seller_tiers: "admin",
  "platform-fee-config": "admin",
  ...
  "tax-documents": "tax",
  tax_documents: "tax",
  "invoices-taxation": "tax",
  invoices_taxation: "tax",
  "tax-invoices": "tax",
  tax_invoices: "tax",
  "credit-notes": "tax",
  credit_notes: "tax",
