const MODULE_CATALOG = [
  ...
  },
  {
    ...
    description: "Curated storefront product collections",
    icon: "collections-bookmark",
    order: 3.72,
    forPlatform: true,
    forSeller: false,
    apiPath: "/admin/platform/collections",
    apiAliases: ["/platform/collections"],
  },
  {
    tab: "Catalog Management",
    slug: "reviews",
  ...
  },
  {
    ...
    name: "Seller Staff Management",
    description: "Seller staff, delegated permissions, and own organizations",
    icon: "users",
    order: 13.05,
    forPlatform: false,
    forSeller: true,
    apiPath: "/sellers/me/sub-admins",
    apiAliases: ["/sellers/me/organizations"],
  },
  {
    tab: "Users & Access",
    slug: "seller_kyc",
  ...
  ...[
    ...
    ["referral-bonus-history", "Referral Bonus History", "/admin/referral/bonus-achievements"],
