...
const SELLER_SIDEBAR_MODULES = [
  ...
  { moduleName: "Finance Overview", moduleKey: "seller-finance-summary", moduleSlug: "seller-finance-summary", icon: "MdAccountBalanceWallet", routePath: "/app/finance-overview", moduleType: "page", order: 91, parentModule: "seller-finance-management", requiredModule: "sellers/commissions" },
  { moduleName: "Earnings", moduleKey: "seller-finance-earnings", moduleSlug: "seller-finance-earnings", icon: "MdTrendingUp", routePath: "/app/finance-earnings", moduleType: "page", order: 92, parentModule: "seller-finance-management", requiredModule: "sellers/commissions" },
  { moduleName: "Adjustments", moduleKey: "seller-finance-adjustments", moduleSlug: "seller-finance-adjustments", icon: "MdTune", routePath: "/app/finance-adjustments", moduleType: "page", order: 93, parentModule: "seller-finance-management", requiredModule: "sellers/commissions" },
  ...
  { moduleName: "Statements", moduleKey: "seller-finance-statements", moduleSlug: "seller-finance-statements", icon: "MdReceiptLong", routePath: "/app/finance-statements", moduleType: "page", order: 95, parentModule: "seller-finance-management", requiredModule: "sellers/commissions" },
...
const ROUTE_METADATA_BY_KEY = {
  ...
  "product-options": {
    supportedRoutes: [
      "/app/product-option-values",
      "/app/product-option-value/:id",
    ],
  },
