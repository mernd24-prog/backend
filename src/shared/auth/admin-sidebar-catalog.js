const SIDEBAR_MODULES = [
  ...
  { moduleName: "Influencer Profiles", moduleKey: "referral-influencers", moduleSlug: "referral-influencers", icon: "MdPeople", routePath: "/app/referral-commerce/influencers", moduleType: "page", order: 132, parentModule: "referral-commerce", requiredModule: "influencer-management" },
  { moduleName: "Influencer Codes", moduleKey: "referral-codes", moduleSlug: "referral-codes", icon: "MdShare", routePath: "/app/referral-commerce/codes", moduleType: "page", order: 133, parentModule: "referral-commerce", requiredModule: "referral-codes" },
  ...
  { moduleName: "Bonus Rules", moduleKey: "referral-bonus-rules", moduleSlug: "referral-bonus-rules", icon: "MdLocalOffer", routePath: "/app/referral-commerce/bonus-rules", moduleType: "page", order: 135, parentModule: "referral-commerce", requiredModule: "referral-bonus-rules" },
  { moduleName: "Bonus Progress", moduleKey: "referral-bonus-progress", moduleSlug: "referral-bonus-progress", icon: "MdBarChart", routePath: "/app/referral-commerce/bonus-progress", moduleType: "page", order: 136, parentModule: "referral-commerce", requiredModule: "referral-bonus-progress" },
  { moduleName: "Bonus History", moduleKey: "referral-bonus-history", moduleSlug: "referral-bonus-history", icon: "MdHistory", routePath: "/app/referral-commerce/bonus-history", moduleType: "page", order: 137, parentModule: "referral-commerce", requiredModule: "referral-bonus-history" },
  { moduleName: "Referral Orders", moduleKey: "referral-orders", moduleSlug: "referral-orders", icon: "MdReceipt", routePath: "/app/referral-commerce/orders", moduleType: "page", order: 138, parentModule: "referral-commerce", requiredModule: "referral-orders" },
  { moduleName: "Wallet Ledger", moduleKey: "referral-ledger", moduleSlug: "referral-ledger", icon: "MdAccountBalanceWallet", routePath: "/app/referral-commerce/commissions", moduleType: "page", order: 139, parentModule: "referral-commerce", requiredModule: "referral-ledger" },
  { moduleName: "Payout Requests", moduleKey: "referral-payouts", moduleSlug: "referral-payouts", icon: "MdPayments", routePath: "/app/referral-commerce/payouts", moduleType: "page", order: 140, parentModule: "referral-commerce", requiredModule: "referral-payouts" },
  { moduleName: "Hierarchy", moduleKey: "referral-hierarchy", moduleSlug: "referral-hierarchy", icon: "MdAccountTree", routePath: "/app/referral-commerce/hierarchy", moduleType: "page", order: 141, parentModule: "referral-commerce", requiredModule: "referral-hierarchy" },
  { moduleName: "Fraud Review", moduleKey: "referral-fraud", moduleSlug: "referral-fraud", icon: "MdSecurity", routePath: "/app/referral-commerce/fraud", moduleType: "page", order: 142, parentModule: "referral-commerce", requiredModule: "referral-fraud" },
...
const SELLER_SIDEBAR_MODULES = [
  { moduleName: "Dashboard", moduleKey: "seller-dashboard-home", moduleSlug: "seller-dashboard-home", icon: "MdOutlineDashboard", routePath: "/app/home", moduleType: "page", order: 1, parentModule: null, requiredModule: "seller-dashboard" },

  { moduleName: "Catalog", moduleKey: "seller-catalog-management", moduleSlug: "seller-catalog-management", icon: "MdInventory", moduleType: "group", order: 30, parentModule: null, requiredModule: "products" },
  { moduleName: "Products", moduleKey: "seller-product-catalog", moduleSlug: "seller-product-catalog", icon: "MdViewList", routePath: "/app/product-catalog", moduleType: "page", order: 31, parentModule: "seller-catalog-management", requiredModule: "products" },
  { moduleName: "Special Price Manager", moduleKey: "seller-special-price-manager", moduleSlug: "seller-special-price-manager", icon: "MdPriceChange", routePath: "/app/seller-special-price-manager", moduleType: "page", order: 32, parentModule: "seller-catalog-management", requiredModule: "products" },
  { moduleName: "Product Reviews", moduleKey: "seller-product-reviews", moduleSlug: "seller-product-reviews", icon: "MdStar", routePath: "/app/product-reviews", moduleType: "page", order: 33, parentModule: "seller-catalog-management", requiredModule: "reviews" },

  { moduleName: "Inventory", moduleKey: "seller-inventory-management", moduleSlug: "seller-inventory-management", icon: "MdWarehouse", moduleType: "group", order: 40, parentModule: null, requiredModule: "inventory" },
  { moduleName: "Inventory", moduleKey: "seller-inventory-products", moduleSlug: "seller-inventory-products", icon: "MdInventory", routePath: "/app/inventory", moduleType: "page", order: 41, parentModule: "seller-inventory-management", requiredModule: "inventory" },
  { moduleName: "Orders", moduleKey: "seller-orders-management", moduleSlug: "seller-orders-management", icon: "MdShoppingCart", moduleType: "group", order: 70, parentModule: null, requiredModule: "orders" },
  { moduleName: "Order List", moduleKey: "seller-orders", moduleSlug: "seller-orders", icon: "MdReceipt", routePath: "/app/orders", moduleType: "page", order: 71, parentModule: "seller-orders-management", requiredModule: "orders" },
  { moduleName: "Returns", moduleKey: "seller-returns", moduleSlug: "seller-returns", icon: "MdAssignmentReturn", routePath: "/app/returns", moduleType: "page", order: 72, parentModule: "seller-orders-management", requiredModule: "returns" },
  { moduleName: "Cancellations", moduleKey: "seller-cancellations", moduleSlug: "seller-cancellations", icon: "MdCancel", routePath: "/app/cancellations", moduleType: "page", order: 73, parentModule: "seller-orders-management", requiredModule: "cancellations" },

  { moduleName: "Shipping", moduleKey: "seller-shipping-management", moduleSlug: "seller-shipping-management", icon: "MdLocalShipping", moduleType: "group", order: 80, parentModule: null, requiredModule: "delivery" },
  { moduleName: "Shipment Tracking", moduleKey: "seller-shipment-tracking", moduleSlug: "seller-shipment-tracking", icon: "MdLocalShipping", routePath: "/app/shipment-tracking", moduleType: "page", order: 81, parentModule: "seller-shipping-management", requiredModule: "delivery" },
  ...
  // { moduleName: "Sub-Admins", moduleKey: "seller-sub-admin-management", moduleSlug: "seller-sub-admin-management", icon: "MdSupervisorAccount", routePath: "/app/seller-sub-admins", moduleType: "page", order: 61, parentModule: "seller-access-management", requiredModule: "seller-management" },
  // { moduleName: "My Store", moduleKey: "seller-my-organizations", moduleSlug: "seller-my-organizations", icon: "MdBusiness", routePath: "/app/my-organizations", moduleType: "page", order: 62, parentModule: "seller-access-management", requiredModule: "seller-management" },

  { moduleName: "My Finance & Payouts", moduleKey: "seller-finance-management", moduleSlug: "seller-finance-management", icon: "MdAccountBalanceWallet", moduleType: "group", order: 90, parentModule: null, requiredModule: "sellers/commissions" },
  { moduleName: "Finance Summary", moduleKey: "seller-finance-summary", moduleSlug: "seller-finance-summary", icon: "MdAccountBalanceWallet", routePath: "/app/seller-finance", moduleType: "page", order: 91, parentModule: "seller-finance-management", requiredModule: "sellers/commissions" },
  { moduleName: "Promotion Funding Ledger", moduleKey: "seller-promotion-funding-ledger", moduleSlug: "seller-promotion-funding-ledger", icon: "MdReceiptLong", routePath: "/app/promotion-funding-ledger", moduleType: "page", order: 92, parentModule: "seller-finance-management", requiredModule: "sellers/commissions" },
  { moduleName: "Wallet", moduleKey: "seller-wallet", moduleSlug: "seller-wallet", icon: "MdAccountBalanceWallet", routePath: "/app/seller-wallet", moduleType: "page", order: 93, parentModule: "seller-finance-management", requiredModule: "sellers/commissions" },
  { moduleName: "Payouts", moduleKey: "seller-my-payouts", moduleSlug: "seller-my-payouts", icon: "MdPayments", routePath: "/app/seller-payouts", moduleType: "page", order: 94, parentModule: "seller-finance-management", requiredModule: "sellers/commissions" },
  { moduleName: "COD Collections", moduleKey: "seller-cod-collections", moduleSlug: "seller-cod-collections", icon: "MdPayments", routePath: "/app/seller-cod-collections", moduleType: "page", order: 95, parentModule: "seller-finance-management", requiredModule: "sellers/commissions" },

  { moduleName: "Invoices", moduleKey: "seller-tax-management", moduleSlug: "seller-tax-management", icon: "MdReceiptLong", moduleType: "group", order: 50, parentModule: null, requiredModule: "tax" },
  { moduleName: "Tax Invoices", moduleKey: "seller-tax-invoices", moduleSlug: "seller-tax-invoices", icon: "MdReceipt", routePath: "/app/tax-invoices", moduleType: "page", order: 51, parentModule: "seller-tax-management", requiredModule: "tax-invoices" },
  { moduleName: "Credit Notes", moduleKey: "seller-credit-notes", moduleSlug: "seller-credit-notes", icon: "MdNote", routePath: "/app/credit-notes", moduleType: "page", order: 52, parentModule: "seller-tax-management", requiredModule: "credit-notes" },

  { moduleName: "My Reports", moduleKey: "seller-reports-management", moduleSlug: "seller-reports-management", icon: "MdBarChart", moduleType: "group", order: 100, parentModule: null, requiredModule: "reports" },
  { moduleName: "Analytics", moduleKey: "seller-analytics-dashboard", moduleSlug: "seller-analytics-dashboard", icon: "MdInsights", routePath: "/app/analytics", moduleType: "page", order: 101, parentModule: "seller-reports-management", requiredModule: "analytics" },
  { moduleName: "Sales Report", moduleKey: "seller-sales-report", moduleSlug: "seller-sales-report", icon: "MdBarChart", routePath: "/app/reports-sales", moduleType: "page", order: 102, parentModule: "seller-reports-management", requiredModule: "reports" },
  { moduleName: "Product Report", moduleKey: "seller-product-report", moduleSlug: "seller-product-report", icon: "MdInventory", routePath: "/app/reports-products", moduleType: "page", order: 103, parentModule: "seller-reports-management", requiredModule: "reports" },
  { moduleName: "Inventory Report", moduleKey: "seller-inventory-report", moduleSlug: "seller-inventory-report", icon: "MdWarehouse", routePath: "/app/reports-inventory", moduleType: "page", order: 104, parentModule: "seller-reports-management", requiredModule: "reports" },

  // { moduleName: "Help & Support", moduleKey: "seller-help-support", moduleSlug: "seller-help-support", icon: "MdSupportAgent", routePath: "/app/help-support", moduleType: "page", order: 100, parentModule: null, requiredModule: "queries" },
].map((module) => ({
  ...module,
