...
const SELLER_SIDEBAR_MODULES = [
  ...
  { moduleName: "My Finance & Payouts", moduleKey: "seller-finance-management", moduleSlug: "seller-finance-management", icon: "MdAccountBalanceWallet", moduleType: "group", order: 10, parentModule: null, requiredModule: "sellers/commissions" },
  { moduleName: "Finance Summary", moduleKey: "seller-finance-summary", moduleSlug: "seller-finance-summary", icon: "MdAccountBalanceWallet", routePath: "/app/seller-finance", moduleType: "page", order: 11, parentModule: "seller-finance-management", requiredModule: "sellers/commissions" },
  { moduleName: "Promotion Funding Ledger", moduleKey: "seller-promotion-funding-ledger", moduleSlug: "seller-promotion-funding-ledger", icon: "MdReceiptLong", routePath: "/app/promotion-funding-ledger", moduleType: "page", order: 11.5, parentModule: "seller-finance-management", requiredModule: "sellers/commissions" },
  { moduleName: "Wallet", moduleKey: "seller-wallet", moduleSlug: "seller-wallet", icon: "MdAccountBalanceWallet", routePath: "/app/seller-wallet", moduleType: "page", order: 12, parentModule: "seller-finance-management", requiredModule: "sellers/commissions" },
  { moduleName: "Payouts", moduleKey: "seller-my-payouts", moduleSlug: "seller-my-payouts", icon: "MdPayments", routePath: "/app/seller-payouts", moduleType: "page", order: 13, parentModule: "seller-finance-management", requiredModule: "sellers/commissions" },
  ...
  { moduleName: "My Reports", moduleKey: "seller-reports-management", moduleSlug: "seller-reports-management", icon: "MdBarChart", moduleType: "group", order: 20, parentModule: null, requiredModule: "reports" },
  { moduleName: "Analytics", moduleKey: "seller-analytics-dashboard", moduleSlug: "seller-analytics-dashboard", icon: "MdInsights", routePath: "/app/analytics", moduleType: "page", order: 21, parentModule: "seller-reports-management", requiredModule: "analytics" },
  { moduleName: "Sales Report", moduleKey: "seller-sales-report", moduleSlug: "seller-sales-report", icon: "MdBarChart", routePath: "/app/reports-sales", moduleType: "page", order: 22, parentModule: "seller-reports-management", requiredModule: "reports" },
  { moduleName: "Product Report", moduleKey: "seller-product-report", moduleSlug: "seller-product-report", icon: "MdInventory", routePath: "/app/reports-products", moduleType: "page", order: 23, parentModule: "seller-reports-management", requiredModule: "reports" },
  { moduleName: "Inventory Report", moduleKey: "seller-inventory-report", moduleSlug: "seller-inventory-report", icon: "MdWarehouse", routePath: "/app/reports-inventory", moduleType: "page", order: 24, parentModule: "seller-reports-management", requiredModule: "reports" },
