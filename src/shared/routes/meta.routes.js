...
const SYSTEM_DROPDOWNS = {
  ...
  "return-statuses": valuesToOptions([
    "requested",
    "approved",
    "rejected",
  ...
  "referral-bonus-periods": valuesToOptions(["monthly", "quarterly", "yearly", "custom"]),
  "referral-bonus-target-types": valuesToOptions(["order_value", "order_count", "customer_count", "active_children"]),
  "referral-bonus-types": valuesToOptions(["fixed_coins", "percentage_extra_coins"]),
  "referral-bonus-apply-to": valuesToOptions(["code_owner", "parent", "child", "all_eligible_influencers"]),
  "referral-bonus-release-rules": valuesToOptions(["instantly_available", "locked_until_all_related_orders_fulfilled", "locked_until_period_ends"]),
  "referral-distribution-types": valuesToOptions(["fixed_amount", "percentage"]),
  "referral-coin-usage-modes": valuesToOptions(["wallet", "discount", "both"]),
  "referral-withdrawal-approval-modes": valuesToOptions(["manual", "auto"]),
  "referral-withdrawal-methods": valuesToOptions(["upi", "bank", "manual"]),
